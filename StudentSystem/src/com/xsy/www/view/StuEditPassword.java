...
//—ß…˙∂À–ﬁ∏ƒ√‹¬Î
public class StuEditPassword extends JInternalFrame {
...
//	}
	...
	public StuEditPassword() {
		...
		if("—ß…˙".equals(StuMainScreen.userType.getNameString())){
			Student student = (Student)StuMainScreen.userObject;
			currentUserLabel.setText("°æ—ß…˙°ø" + student.getName());
			return;
